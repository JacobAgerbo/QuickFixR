    ...
    tabPanel("Barplots",
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          # Select taxon level
          selectInput("relabu_bar_taxlev", "Class Level", choices=tax.name, selected=tax.default),
          ...
          # Do plot button
          withBusyIndicatorUI(
          actionButton("relabu_bar_plot_btn", "Go!", class = "btn-primary")
          ),
          width=3
        ),
        mainPanel(
    ...
    tabPanel("Heatmap",
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          # Do plot button
          withBusyIndicatorUI(
          actionButton("relabu_heatmap_plot_btn", "Go!", class = "btn-primary")
          ),
          width=3
        ),
        mainPanel(
    ...
    tabPanel("Boxplots",
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          selectInput("relabu_box_taxlev", "Classification Levels", choices=tax.name, selected=tax.default, multiple=FALSE),
          ...
          # Do plot button
          withBusyIndicatorUI(
            actionButton("relabu_box_plot_btn", "Go!", class = "btn-primary")
          ),
          width=3
        ),
        mainPanel(
